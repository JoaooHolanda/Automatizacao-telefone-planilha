...
try:
    tabela = pd.read_excel('Planilha_A_editar.xlsx')
     ...
     exibir_alerta('Aquivo não encontrado','Por gentileza despejar na pasta um arquivo com o nome: Planilha_A_editar.xlsx ')
...
while(validador != 0):
        ...
        if linha == len(tabela):
             ...
             tabela.to_excel("Planilha_Tratada.xlsx",index=False) 
             validador = 0
